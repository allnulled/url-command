...
function createVersionBranch() {
  try {
    ...
    execSync(`read -p "Escribe tu mensaje de commit (rama actual): " mensaje && git commit -m "$mensaje"`, { stdio: "inherit" });
    ...
    execSync(`git add .`, { stdio: "inherit" });
    execSync(`read -p "Escribe tu mensaje de commit (rama «main»): " mensaje && git commit -m "$mensaje"`, { stdio: "inherit" });
